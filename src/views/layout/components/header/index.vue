<template>
    <div class="w-screen bg-white dark:bg-zinc-800 border-b border-b-zinc-200 dark:border-b-zinc-700 px-2 py-1">
        <div class="flex items-center">
            ...
            <m-svg-icon name="hacker" class="h-4 cursor-pointer w-6"></m-svg-icon>
            <header-search-vue class="mr-1"></header-search-vue>
            <header-theme-vue class="mr-1"></header-theme-vue>
            <header-my-vue class=""></header-my-vue>
        </div>
    </div>
</template>
